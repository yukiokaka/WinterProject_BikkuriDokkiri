...
// for something else
extern const UNSIGNED8 flash_nvol_section1[];
extern const UNSIGNED8 flash_nvol_section2[];

// start address and numbers for two sectors used for storing
// non-volatile variables
#define SECTOR1_STARTADDR flash_nvol_section1
#define SECTOR1_NUM       ((uint32_t)flash_nvol_section1 >> 12)
#define SECTOR2_STARTADDR flash_nvol_section2
#define SECTOR2_NUM       ((uint32_t)flash_nvol_section2 >> 12)
// size of sectors - they must be the same size
#define SECTOR_SIZE 0x1000
// CPU clock in kHz
//#define CPU_CLK 36000//defined in makefile
...
// define sectors
/* initialized in NVOL_Init */
static SECTOR mSector1;
static SECTOR mSector2;
...
{
  // initialize sectors
  mSector1.Addr = (UNSIGNED8*)SECTOR1_STARTADDR;
  mSector1.Num = SECTOR1_NUM;
  mSector2.Addr = (UNSIGNED8*)SECTOR2_STARTADDR;
  mSector2.Num = SECTOR2_NUM;
