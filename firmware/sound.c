...
)
{
	...
	__enable_ahbclk(PCCT32B1);	/* Enable CT32B1 module */
	...
	__enable_ahbclk(PCSSP0);	/* Enable CT32B0 module */
	...
	__set_irqn_priority(CT32B0_IRQn, 0);	/* Set interrupt priority, highest */
